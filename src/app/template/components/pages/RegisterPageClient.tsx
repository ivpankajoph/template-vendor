    ...
    <div className={`${pageClass} template-page-shell template-auth-page`}>
      <div className="mx-auto flex min-h-screen max-w-5xl items-center justify-center px-6 py-16">
        <div className={cardClass}>
          <h1 className={isStudio ? "template-section-title text-3xl font-bold text-slate-100" : "template-section-title text-3xl font-bold text-slate-900"}>Create account</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              <label className={isStudio ? "text-sm font-medium text-slate-200" : "text-sm font-medium text-slate-700"}>Name</label>
              <input
                value={name}
            ...
            <div>
              <label className={isStudio ? "text-sm font-medium text-slate-200" : "text-sm font-medium text-slate-700"}>Email</label>
              <input
                value={email}
            ...
            <div>
              <label className={isStudio ? "text-sm font-medium text-slate-200" : "text-sm font-medium text-slate-700"}>Phone</label>
              <input
                value={phone}
